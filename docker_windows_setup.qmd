...
Here is a list of the key commands, note that you will hit Enter after each command. Comments are denoted by the lines beginning with `#` and do not need to be entered. Also note that the first time you run a command involving `sudo` that you will need to enter the password you created for your default UNIX account in the virtual machine.
...
# Use legacy iptables - select option 1
