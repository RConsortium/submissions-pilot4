...
{{< revealjs "materials/wsl-setup-resources/index.html" height="420px" width="747px" class="ratio ratio-16x9" >}}
...
{{< revealjs "materials/ubuntu-setup-resources/index.html" height="420px" width="747px" class="ratio ratio-16x9" >}}
...
After installing WSL on your Windows machine, you are now ready to install the Docker container runtime. While the [Docker Desktop](https://www.docker.com/products/docker-desktop/) is an available option, the utility can prove to be unstable in certain Windows machines. The recommended approach for this Pilot is to install the Docker community edition directly on the Ubuntu Linux virtual machine powered by WSL.
...
{{< video assets/img/ubuntu_install_docker.mp4 >}}
